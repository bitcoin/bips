...
// github.com/btcsuite/btcd/descriptors and its miniscript package.
//
...
var (
	// vectorFiles lists every known vector file. A file that is not present
	// is reported as missing and skipped.
