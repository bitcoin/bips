...
* License — The License header specifies SPDX License Expressions describing the licenses under which the
...
In this case, the BIP (including all auxiliary files) is made available under the terms of both Creative Commons Zero v1.0 Universal as well as the
...
If different from those specified in the License header, each auxiliary source code file or source directory should specify the license under which it is made available as is common in
...
A few BIP2-era BIPs may have a License-Code header; in such cases please refer to BIP2.
