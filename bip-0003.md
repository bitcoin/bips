...
Proposals are merged to this repository if they are on-topic and fulfill the editorial criteria.
...
Vetting an idea publicly before investing time and effort to formally describe the idea is meant to save time both the authors and
