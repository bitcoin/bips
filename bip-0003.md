...
date, and description in a Changelog section. The changelog is sorted latest version first. The version number is inspired by semantic versioning (MAJOR.MINOR.PATCH).
