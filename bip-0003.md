...
> **⚠️ Note from the BIP Editor (Bryan Bishop):** BIP 3 is not a policy document and is not binding in any way. Editorial decisions regarding the BIP repository remain at the sole discretion of the BIP Editor. It would be inappropriate to allow an outside process to supplant the editor's own judgment. This document does not create any obligations for the BIP Editor. It is unfortunate that this misunderstanding has persisted.
