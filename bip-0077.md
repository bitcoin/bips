...
withdrawals. Payjoin enables more blockspace-efficient transactions that
...
- The receiver gets this message and
  ...
  in response, by updating the Original PSBT with appropriate inputs and/or
  outputs.
...
In Payjoin version 2 the URL in the `pj` parameter value is the mailbox
...
may be used in Payjoin v2, but must be included in
