...
The device object may contain any of these fields.  

```
| field             | optional | type      | description                                          |
|-------------------|----------|-----------|------------------------------------------------------|
| vendor            | optional | string    | Device vendor name.                                  |
|-------------------|----------|-----------|------------------------------------------------------|
...
|                   |          |           | device.                                              |
|-------------------|----------|-----------|------------------------------------------------------|
| por               | optional | string    | Proof of registration generated by stateless devices |
|                   |          |           | such as Ledger.                                      |
|-------------------|----------|-----------|------------------------------------------------------|
